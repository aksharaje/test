...
def upgrade() -> None:
    ...
    if 'jira_projects' not in existing_tables:
    ...
    if 'library_pages' not in existing_tables:
    ...
    if 'library_integrations' not in existing_tables:
    ...
    # Code Chat
    if 'code_chat_sessions' not in existing_tables:
    ...
    if 'code_chat_messages' not in existing_tables:
    ...
    if 'split_tests' not in existing_tables:
    ...
    if 'story_generator_split_tests' not in existing_tables:
    ...
    if 'generation_feedback' not in existing_tables:
    ...
    if 'prd_templates' not in existing_tables:
    ...
    if 'generated_prds' not in existing_tables:
    ...
    # PI Planning
    if 'pi_sessions' not in existing_tables:
    ...
    if 'pi_session_boards' not in existing_tables:
    ...
    if 'pi_sprints' not in existing_tables:
    ...
    if 'pi_features' not in existing_tables:
    ...
    if 'pi_feature_assignments' not in existing_tables:
    ...
    # Ideation
    if 'ideation_sessions' not in existing_tables:
    ...
    if 'idea_clusters' not in existing_tables:
    ...
    if 'generated_ideas' not in existing_tables:
    ...
    if 'holiday_configs' not in existing_tables:
