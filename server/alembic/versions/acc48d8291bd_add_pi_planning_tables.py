"""Add PI Planning tables

Revision ID: acc48d8291bd
Revises: 0b1cb4eb912d
Create Date: 2025-12-05 19:04:34.843731
...
def upgrade() -> None:
    ...
    sa.Column('project_keys', sa.JSON(), nullable=True),
    sa.Column('start_date', sa.DateTime(), nullable=True),
    sa.Column('end_date', sa.DateTime(), nullable=True),
    sa.Column('sprint_count', sa.Integer(), nullable=False),
    sa.Column('sprint_length_weeks', sa.Integer(), nullable=False),
    sa.Column('plannable_issue_type', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('custom_issue_type_name', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    ...
    op.alter_column('holiday_configs', 'name',
               existing_type=sa.TEXT(),
               type_=sqlmodel.sql.sqltypes.AutoString(),
               existing_nullable=False)
    op.alter_column('holiday_configs', 'calendar_type',
               existing_type=sa.TEXT(),
               type_=sqlmodel.sql.sqltypes.AutoString(),
               existing_nullable=False)
    op.alter_column('holiday_configs', 'country_codes',
               existing_type=postgresql.JSONB(astext_type=sa.Text()),
               type_=sa.JSON(),
               existing_nullable=True,
               existing_server_default=sa.text("'[]'::jsonb"))
    op.alter_column('holiday_configs', 'is_default', server_default=None)
    op.alter_column('holiday_configs', 'is_default',
               existing_type=sa.INTEGER(),
               type_=sa.Boolean(),
               nullable=False,
               postgresql_using='is_default::boolean')
    op.alter_column('holiday_configs', 'is_default', server_default=sa.text('false'))
    op.drop_column('holiday_configs', 'updated_at')
    op.drop_column('holiday_configs', 'created_at')
    op.add_column('pi_feature_assignments', sa.Column('is_manual_override', sa.Boolean(), nullable=False))
    op.alter_column('pi_feature_assignments', 'ai_rationale',
               existing_type=sa.TEXT(),
               type_=sqlmodel.sql.sqltypes.AutoString(),
               existing_nullable=True)
    ...
    op.drop_constraint(op.f('pi_feature_assignments_session_id_pi_planning_sessions_id_fk'), 'pi_feature_assignments', type_='foreignkey')
    op.drop_constraint(op.f('pi_feature_assignments_feature_id_pi_features_id_fk'), 'pi_feature_assignments', type_='foreignkey')
    op.create_foreign_key(None, 'pi_feature_assignments', 'pi_features', ['feature_id'], ['id'])
    op.create_foreign_key(None, 'pi_feature_assignments', 'pi_session_boards', ['board_id'], ['id'])
    op.drop_column('pi_feature_assignments', 'sequence_in_sprint')
    op.drop_column('pi_feature_assignments', 'manual_override')
    op.drop_column('pi_feature_assignments', 'session_id')
    op.drop_column('pi_feature_assignments', 'override_reason')
    op.drop_column('pi_feature_assignments', 'updated_at')
    op.drop_column('pi_feature_assignments', 'created_at')
    op.alter_column('pi_features', 'jira_issue_id',
               existing_type=sa.TEXT(),
               type_=sqlmodel.sql.sqltypes.AutoString(),
               existing_nullable=True)
    op.alter_column('pi_features', 'jira_issue_key',
               existing_type=sa.TEXT(),
               type_=sqlmodel.sql.sqltypes.AutoString(),
               existing_nullable=True)
    op.alter_column('pi_features', 'title',
               existing_type=sa.TEXT(),
               type_=sqlmodel.sql.sqltypes.AutoString(),
               existing_nullable=False)
    op.alter_column('pi_features', 'description',
               existing_type=sa.TEXT(),
               type_=sqlmodel.sql.sqltypes.AutoString(),
               existing_nullable=True)
    op.alter_column('pi_features', 'issue_type',
               existing_type=sa.TEXT(),
               type_=sqlmodel.sql.sqltypes.AutoString(),
               existing_nullable=True)
    op.alter_column('pi_features', 'priority',
               existing_type=sa.TEXT(),
               type_=sqlmodel.sql.sqltypes.AutoString(),
               existing_nullable=True)
    op.alter_column('pi_features', 'estimated_sprints',
               existing_type=sa.INTEGER(),
               nullable=False,
               existing_server_default=sa.text('1'))
    op.alter_column('pi_features', 'dependencies',
               existing_type=postgresql.JSONB(astext_type=sa.Text()),
               type_=sa.JSON(),
               existing_nullable=True,
               existing_server_default=sa.text("'[]'::jsonb"))
    op.alter_column('pi_features', 'labels',
               existing_type=postgresql.JSONB(astext_type=sa.Text()),
               type_=sa.JSON(),
               existing_nullable=True,
               existing_server_default=sa.text("'[]'::jsonb"))
    op.alter_column('pi_features', 'project_key',
               existing_type=sa.TEXT(),
               type_=sqlmodel.sql.sqltypes.AutoString(),
               existing_nullable=True)
    op.alter_column('pi_features', 'status',
               existing_type=sa.TEXT(),
               type_=sqlmodel.sql.sqltypes.AutoString(),
               existing_nullable=True)
    ...
    op.drop_constraint(op.f('pi_features_session_id_pi_planning_sessions_id_fk'), 'pi_features', type_='foreignkey')
    op.create_foreign_key(None, 'pi_features', 'pi_sessions', ['session_id'], ['id'])
    op.drop_column('pi_features', 'updated_at')
    op.drop_column('pi_features', 'created_at')
    op.drop_column('pi_features', 'imported_at')
    op.add_column('pi_session_boards', sa.Column('jira_board_id', sa.Integer(), nullable=False))
    op.add_column('pi_session_boards', sa.Column('name', sqlmodel.sql.sqltypes.AutoString(), nullable=False))
    op.add_column('pi_session_boards', sa.Column('board_type', sqlmodel.sql.sqltypes.AutoString(), nullable=False))
    op.add_column('pi_session_boards', sa.Column('default_velocity', sa.Integer(), nullable=True))
    op.drop_index(op.f('pi_session_boards_session_idx'), table_name='pi_session_boards')
    op.drop_constraint(op.f('pi_session_boards_session_id_pi_planning_sessions_id_fk'), 'pi_session_boards', type_='foreignkey')
    op.create_foreign_key(None, 'pi_session_boards', 'pi_sessions', ['session_id'], ['id'])
    op.drop_column('pi_session_boards', 'board_name')
    op.drop_column('pi_session_boards', 'velocity_override')
    op.drop_column('pi_session_boards', 'board_id')
    op.drop_column('pi_session_boards', 'created_at')
    op.drop_column('pi_session_boards', 'capacity_adjustment')
    op.alter_column('pi_sprints', 'name',
               existing_type=sa.TEXT(),
               type_=sqlmodel.sql.sqltypes.AutoString(),
               existing_nullable=False)
    op.alter_column('pi_sprints', 'holidays',
               existing_type=postgresql.JSONB(astext_type=sa.Text()),
               type_=sa.JSON(),
               existing_nullable=True,
               existing_server_default=sa.text("'[]'::jsonb"))
    op.alter_column('pi_sprints', 'is_ip_sprint', server_default=None)
    op.alter_column('pi_sprints', 'is_ip_sprint',
               existing_type=sa.INTEGER(),
               type_=sa.Boolean(),
               nullable=False,
               postgresql_using='is_ip_sprint::boolean')
    op.alter_column('pi_sprints', 'is_ip_sprint', server_default=sa.text('false'))
    ...
    op.drop_constraint(op.f('pi_sprints_session_id_pi_planning_sessions_id_fk'), 'pi_sprints', type_='foreignkey')
    op.create_foreign_key(None, 'pi_sprints', 'pi_sessions', ['session_id'], ['id'])
    op.drop_column('pi_sprints', 'created_at')
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('pi_sprints', sa.Column('created_at', postgresql.TIMESTAMP(), server_default=sa.text('now()'), autoincrement=False, nullable=False))
    op.drop_constraint(None, 'pi_sprints', type_='foreignkey')
    op.create_foreign_key(op.f('pi_sprints_session_id_pi_planning_sessions_id_fk'), 'pi_sprints', 'pi_planning_sessions', ['session_id'], ['id'], ondelete='CASCADE')
    ...
    op.alter_column('pi_sprints', 'name',
               ...
               type_=sa.TEXT(),
               existing_nullable=False)
    op.add_column('pi_session_boards', sa.Column('capacity_adjustment', sa.INTEGER(), server_default=sa.text('100'), autoincrement=False, nullable=True))
    op.add_column('pi_session_boards', sa.Column('created_at', postgresql.TIMESTAMP(), server_default=sa.text('now()'), autoincrement=False, nullable=False))
    op.add_column('pi_session_boards', sa.Column('board_id', sa.INTEGER(), autoincrement=False, nullable=False))
    op.add_column('pi_session_boards', sa.Column('velocity_override', sa.INTEGER(), autoincrement=False, nullable=True))
    op.add_column('pi_session_boards', sa.Column('board_name', sa.TEXT(), autoincrement=False, nullable=False))
    op.drop_constraint(None, 'pi_session_boards', type_='foreignkey')
    op.create_foreign_key(op.f('pi_session_boards_session_id_pi_planning_sessions_id_fk'), 'pi_session_boards', 'pi_planning_sessions', ['session_id'], ['id'], ondelete='CASCADE')
    op.create_index(op.f('pi_session_boards_session_idx'), 'pi_session_boards', ['session_id'], unique=False)
    op.drop_column('pi_session_boards', 'default_velocity')
    op.drop_column('pi_session_boards', 'board_type')
    op.drop_column('pi_session_boards', 'name')
    op.drop_column('pi_session_boards', 'jira_board_id')
    op.add_column('pi_features', sa.Column('imported_at', postgresql.TIMESTAMP(), server_default=sa.text('now()'), autoincrement=False, nullable=False))
    op.add_column('pi_features', sa.Column('created_at', postgresql.TIMESTAMP(), server_default=sa.text('now()'), autoincrement=False, nullable=False))
    op.add_column('pi_features', sa.Column('updated_at', postgresql.TIMESTAMP(), server_default=sa.text('now()'), autoincrement=False, nullable=False))
    op.drop_constraint(None, 'pi_features', type_='foreignkey')
    op.create_foreign_key(op.f('pi_features_session_id_pi_planning_sessions_id_fk'), 'pi_features', 'pi_planning_sessions', ['session_id'], ['id'], ondelete='CASCADE')
    ...
    op.alter_column('pi_features', 'jira_issue_id',
               ...
               type_=sa.TEXT(),
               existing_nullable=True)
    op.add_column('pi_feature_assignments', sa.Column('created_at', postgresql.TIMESTAMP(), server_default=sa.text('now()'), autoincrement=False, nullable=False))
    op.add_column('pi_feature_assignments', sa.Column('updated_at', postgresql.TIMESTAMP(), server_default=sa.text('now()'), autoincrement=False, nullable=False))
    op.add_column('pi_feature_assignments', sa.Column('override_reason', sa.TEXT(), autoincrement=False, nullable=True))
    op.add_column('pi_feature_assignments', sa.Column('session_id', sa.INTEGER(), autoincrement=False, nullable=False))
    op.add_column('pi_feature_assignments', sa.Column('manual_override', sa.INTEGER(), server_default=sa.text('0'), autoincrement=False, nullable=True))
    op.add_column('pi_feature_assignments', sa.Column('sequence_in_sprint', sa.INTEGER(), server_default=sa.text('0'), autoincrement=False, nullable=True))
    op.drop_constraint(None, 'pi_feature_assignments', type_='foreignkey')
    op.drop_constraint(None, 'pi_feature_assignments', type_='foreignkey')
    op.create_foreign_key(op.f('pi_feature_assignments_feature_id_pi_features_id_fk'), 'pi_feature_assignments', 'pi_features', ['feature_id'], ['id'], ondelete='CASCADE')
    op.create_foreign_key(op.f('pi_feature_assignments_session_id_pi_planning_sessions_id_fk'), 'pi_feature_assignments', 'pi_planning_sessions', ['session_id'], ['id'], ondelete='CASCADE')
    ...
    op.alter_column('pi_feature_assignments', 'ai_rationale',
               ...
               type_=sa.TEXT(),
               existing_nullable=True)
    op.drop_column('pi_feature_assignments', 'is_manual_override')
    op.add_column('holiday_configs', sa.Column('created_at', postgresql.TIMESTAMP(), server_default=sa.text('now()'), autoincrement=False, nullable=False))
    op.add_column('holiday_configs', sa.Column('updated_at', postgresql.TIMESTAMP(), server_default=sa.text('now()'), autoincrement=False, nullable=False))
    op.alter_column('holiday_configs', 'is_default',
               existing_type=sa.Boolean(),
               type_=sa.INTEGER(),
               nullable=True,
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(), server_default=sa.text('now()'), autoincrement=False, nullable=False),
    sa.Column('updated_at', postgresql.TIMESTAMP(), server_default=sa.text('now()'), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['agent_id'], ['agents.id'], name=op.f('conversations_agent_id_agents_id_fk')),
